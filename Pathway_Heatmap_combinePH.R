...
ht0 <- Heatmap(PHsplit, name="Sig")
ht1 <- Heatmap(raPH,name="relative%", column_names_gp = gpar(fontsize = 9), cluster_columns = FALSE,row_names_side = "right",
...
jpeg(paste0(outname, ".jpg"), width = 2800, height = 3000, res=300 )
draw(ht_list, ,heatmap_legend_side = "left", row_split = PHsplit)
dev.off()
